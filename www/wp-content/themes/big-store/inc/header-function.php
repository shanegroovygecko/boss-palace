...
<div class="main-header <?php echo esc_attr($main_header_layout);?> <?php echo esc_attr($main_header_opt);?> <?php echo esc_attr($big_store_menu_alignment);?>  <?php echo esc_attr($offcanvas);?>">
        ...
        <div class="desktop-main-header">
          ...
          <span class="logo-content">
           ...
           <?php if(function_exists('big_store_show_off_canvas_sidebar_icon')){big_store_show_off_canvas_sidebar_icon();} ?>
        </div>
      ...
      <?php } ?>
        ...
        <?php if(class_exists( 'WooCommerce' )){ big_store_account(); } ?>
...
function big_store_main_header_optn(){
         ...
         <?php if($big_store_main_header_option =='button'){?>
          ...
          <?php }
          elseif($big_store_main_header_option =='callto'){ ?>
...
// Product search
/***************************/
function big_store_product_search_box(){ ?>             
<div id='search-box' class="wow thmkfadeInDown" data-wow-duration="1s">
<form action='<?php echo esc_url( home_url( '/'  ) ); ?>' id='search-form' class="woocommerce-product-search" method='get' target='_top'>
   <input id='search-text' name='s' placeholder='<?php echo esc_attr(get_theme_mod('search_box_text',esc_attr_x( 'Search for Product', 'placeholder', 'big-store' ))); ?>' class="form-control search-autocomplete" value='<?php echo get_search_query(); ?>' type='text' title='<?php echo esc_attr_x( 'Search for:', 'label', 'big-store' ); ?>' />
...
$args = array(
  ...
  'orderby'    => 'menu_order',
   'value_field' => 'slug',
   'class' => 'something',
   'show_option_all'   => __('All Category','big-store'),
);
wp_dropdown_categories( $args );
endif;
?>
                        <button id='search-button' value="<?php echo esc_attr_x( 'Submit','submit button', 'big-store' ); ?>" type='submit'>                     
                          <?php echo esc_html__( 'Search', 'big-store' ); ?>
                        </button>
